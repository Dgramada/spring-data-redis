...
class DefaultJsonResultUnitTests {
	...
	void testAsClassDeserializesPojo() {
		...
		DefaultJsonResult result = new DefaultJsonResult(mapper, mapper.toJson(person));
	...
	void testAsTypeRefDeserializesGenericList() {
		...
		DefaultJsonResult result = new DefaultJsonResult(mapper, "[1,2,3]");
	...
	void testAsStringReturnsRawPayload() {
		...
		DefaultJsonResult result = new DefaultJsonResult(mapper, "{\"name\":\"rand\"}");
